...
import com.generation.projetoecorede.repository.UsuarioRepository;
...
public class UsuarioController {
	...
	public ResponseEntity<List<Usuario>> getAll(){
		...
		public ResponseEntity <List<Usuario>> getByTopico(@PathVariable String usuario){
		...
		public ResponseEntity<?> deleteUsuario(@PathVariable Long id) {
			...
			return usuarioRepository.findById(id)
					.map(resposta -> {usuarioRepository.deleteById(id);
